...
const action =newBooking("ELia", 25)
store.dispatch(action)//quello che fa eseguire l'azione
store.dispatch(newBooking("Gianni", 25))
store.dispatch(cancelBooking("ELia", 10))
